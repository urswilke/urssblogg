...
more detail what kind of data structures are used to control the machine. If you want 
to try out the machine, have a look at the [chaos machine package](https://gitlab.com/urswilke/chaosmachine).
