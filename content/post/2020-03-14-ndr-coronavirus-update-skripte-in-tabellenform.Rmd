---
title: NDR Coronavirus-Update-Skripte in Tabellenform
author: Urs Wilke
date: '2020-03-14'
slug: ndr-coronavirus-update-skripte-in-tabellenform
categories: []
tags: []
subtitle: ''
summary: ''
authors: []
lastmod: '2020-03-14T03:14:00+01:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
df_saetze <- 
  ...
  fill(i) %>% 
  group_by_at(c("Titel", "url", "Datum", "Themen", "Absatz")) %>% 
...
d <- df_saetze %>% 
  ...
  DT::datatable(filter = "top", 
                rownames = FALSE,
                options = list(
                  columnDefs = list(list(visible=FALSE, targets=3:5)),
                  dom = 'BfrtiP',
