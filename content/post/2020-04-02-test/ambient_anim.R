...
# knitr::opts_knit$set(root.dir = "~/R/urssblogg/static/external_files/ambient_anim/")

#' 
#' ## Setup
#' 
#' This script is inspirated by https://www.data-imaginist.com/2020/a-noisy-start/. To understand the code, I recommend to read it first.
#' 
## ----load_libs-----------------------------------------------------------------------------------------------------------------------------------
library(ambient)
library(tidyverse)
...
#' 
#' Furthermore, the packages {paletteer}, {animation} and {tweenr} are needed. (I really love these packages `r emo::ji("star_struck")`) 
#' 
...
#' 
#' 
#' Create list of grids based on an increasing sequence of frequencies (we take the same simplex noise `pertube` defined before):
#' 
## ----grid_list-----------------------------------------------------------------------------------------------------------------------------------
...
## ----giff----------------------------------------------------------------------------------------------------------------------------------------
1
knitr::include_graphics("ambient_anim_plot.gif", error = FALSE)
...
#' 
#' Instead of switching the wave frequency it is also possible to tween between
...
#' 
#' After having done that I realized that instead of tweening one can also create smooth transitions be using a third dimension
